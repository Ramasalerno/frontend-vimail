...
export default function FlexFeatures() {
  return (
    <>
      <section>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#222" fillOpacity="1" d="M0,128L48,112C96,96,192,64,288,69.3C384,75,480,117,576,112C672,107,768,53,864,64C960,75,1056,149,1152,170.7C1248,192,1344,160,1392,144L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
        <div className="bgRari">
          <div className="container">
            <header className="center btm-spacer">
              <h2 className="mb-5">Obtene todos estos beneficios!</h2>
            </header>
              ...
              <div className="col-md-4">
                <div className="center">
                  <span className="fa-stack fa-2x">
                    ...
                    <i className="fa-solid fa-circle fa-stack-2x circulo"></i>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#222" fillOpacity="1" d="M0,128L48,112C96,96,192,64,288,69.3C384,75,480,117,576,112C672,107,768,53,864,64C960,75,1056,149,1152,170.7C1248,192,1344,160,1392,144L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
      </section>
    </>
  );
}
